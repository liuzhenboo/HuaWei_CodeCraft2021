...
void runJudger(std::string inputFile,std::string outputFile) {
    ...
    //std::cout<<"read virtual type"<<std::endl;
    ...
    for (int date = 0; date < T; ++date)
    {
        ...
        // read purchase
        //std::cout<<"read purchase"<<std::endl;
        ...
        // read migration
        //std::cout<<"read migration"<<std::endl;
        getline(outfile, tmp_str);
        tmp_str.pop_back();
        //std::cout<<"tmp_str="<<tmp_str<<std::endl;
        //std::cout<<"tmp_str.substr="<<tmp_str.substr(11)<<std::endl;
        int mi_num = std::stoi(tmp_str.substr(11));
        //std::cout<<"---qwe---"<<std::endl;
        mi += mi_num;
        //std::cout<<"mi_num="<<mi_num<<std::endl;
        //std::cout<<"5 * (int)virs.size() / 1000="<<5 * (int)virs.size() / 1000<<std::endl;

        //std::cout<<"virs.size="<<virs.size()<<std::endl;
        //std::cout<<"constraint="<<5 * (int)virs.size() / 1000<<std::endl;
        ...
        for (int i = 0; i < mi_num; ++i)
        {
            ...
            //std::cout<<"vir_id="<<vir_id<<std::endl;
            ...
            tmp_str = tmp_str.substr(tmp_str.find(',') + 1);
            //std::cout<<"tmp_str123="<<tmp_str<<std::endl;
        ...
        // read operator
        //std::cout<<"read operator"<<std::endl;
        int n;
        infile >> n;
        infile.ignore();
        while (n--) {
        ...
        //std::cout<<"calculate daily-cost"<<std::endl;
